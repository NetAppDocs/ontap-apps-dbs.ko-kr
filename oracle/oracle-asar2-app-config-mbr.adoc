...
summary: Oracle 데이터베이스 매개변수 - ASA r2의 db_file_multiblock_read_count 
searchtitle: Oracle 데이터베이스 매개변수 - ASA r2의 db_file_multiblock_read_count 
---
...
AFF/ FAS 시스템과 비교했을 때 권장 사항에는 변경 사항이 없습니다. ONTAP 동작 방식과 Oracle의 모범 사례는 ASA r2, AFF 및 FAS 플랫폼 전반에 걸쳐 동일하게 유지됩니다.
