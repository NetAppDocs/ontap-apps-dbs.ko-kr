...
NOTE: vVols를 사용하려면 ONTAP용 VASA Provider로 기능하는 VMware vSphere용 ONTAP tools가 필요합니다. vVols 모범 사례는 link:vmware-vvols-overview.html["ONTAP을 사용한 VVOL(VMware vSphere 가상 볼륨"]을 참조하십시오.
