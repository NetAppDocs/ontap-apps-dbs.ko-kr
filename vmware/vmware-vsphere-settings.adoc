...
| newSyncInterval | Kubernetes용 vSphere CSI를 사용하지 않는 경우, per를 설정합니다. https://knowledge.broadcom.com/external/article/415074/reducing-or-disabling-excessive-vsan-cns.html["VMware KB 415074"^] | 아니요 
