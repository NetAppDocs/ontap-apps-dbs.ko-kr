...
스냅샷은 ONTAP의 핵심 기능으로, 특정 시점의 데이터 복사본을 생성할 수 있습니다. 스냅샷은 공간 효율성이 뛰어나고 빠르게 생성할 수 있으므로 VM과 데이터스토어를 보호하는 데 이상적입니다. 스냅샷은 백업, 복구, 테스트 등 다양한 용도로 사용할 수 있습니다. 이러한 스냅샷은 VMware(일관성) 스냅샷과는 다르며 장기적인 데이터 보호에 적합합니다. VMware의 vCenter에서 관리하는 스냅샷은 성능 및 기타 영향으로 인해 단기적인 용도로만 사용하는 것이 좋습니다. 자세한 내용은 https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-1/vsphere-virtual-machine-administration/managing-virtual-machines/using-snapshots-to-manage-virtual-machines/snapshot-file-names-and-description.html["스냅샷 파일 및 제한 사항"^]을 참조하십시오.
...
스냅샷에 대한 자세한 내용은 ONTAP 설명서를 참조하십시오. 다음 링크에서 추가 정보를 확인할 수 있습니다. https://docs.netapp.com/us-en/ontap/data-protection/manage-local-snapshot-copies-concept.html["ONTAP 로컬 스냅샷 복사본"^] https://docs.netapp.com/us-en/ontap/data-protection/snapmirror-replication-workflow-concept.html["ONTAP SnapMirror 복제 워크플로"^]
