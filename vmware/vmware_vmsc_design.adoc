...
image::../media/vmsc_3_9.png[설명 텍스트가 자동으로 생성됩니다,528,94]

. Enable I/O Metric for SDRS Recommendations 확인란이 선택되어 있는지 확인합니다. 메트릭 설정을 기본값으로 유지할 수 있습니다.


image::../media/vmsc_3_10.png[자동으로 생성된 컴퓨터 설명 스크린샷,624,241]

. HA 클러스터를 선택하고 Next를 클릭합니다.


image::../media/vmsc_3_11.png[자동으로 생성된 컴퓨터 설명 스크린샷,624,149]

. 사이트 A에 속하는 데이터 저장소를 선택하고 Next를 클릭합니다.


image::../media/vmsc_3_12.png[자동으로 생성된 컴퓨터 설명 스크린샷,624,134]
