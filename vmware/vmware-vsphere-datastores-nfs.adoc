...
* link:vmware-vsphere-settings.html["설정"]에서 언급한 바와 같이 Kubernetes용 vSphere CSI를 사용하지 않는 경우  https://knowledge.broadcom.com/external/article/415074/reducing-or-disabling-excessive-vsan-cns.html["VMware KB 415074"^]에 따라 newSyncInterval을 설정해야 합니다.
