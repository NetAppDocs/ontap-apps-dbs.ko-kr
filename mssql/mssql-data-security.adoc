...
ONTAP 9.12.1부터 스냅샷은 읽기 전용일 뿐만 아니라 실수 또는 의도적인 삭제로부터 보호될 수 있습니다. 이 기능을 변조 방지 스냅샷이라고 합니다. 스냅샷 정책을 통해 보존 기간을 설정하고 적용할 수 있습니다. 생성된 스냅샷은 만료일에 도달할 때까지 삭제할 수 없습니다. 관리자 또는 지원 센터의 재정의는 없습니다.
